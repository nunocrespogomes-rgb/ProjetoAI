<x-layouts::main-content
    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white dark:bg-zinc-900 p-6 rounded-xl border border-zinc-200 dark:border-zinc-700 shadow-sm">
            ...
            <div class="w-full max-w-md aspect-square bg-zinc-100 dark:bg-zinc-950 rounded-xl flex items-center justify-center p-4 overflow-hidden shrink-0 border border-zinc-200 dark:border-zinc-700 shadow-sm">
                @php
