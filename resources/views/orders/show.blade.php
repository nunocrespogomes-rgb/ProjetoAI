        ...
        <div class="p-4 rounded-xl border flex flex-col gap-2 
            ...
            <div class="flex items-center justify-between">
                ...
                @if($order->status === 'closed')
                    <flux:button href="#" icon="arrow-down-tray" variant="filled" size="sm">
            ...
            @if($order->status === 'canceled' && $order->canceled_reason)
                <div class="mt-2 pt-2 border-t border-rose-200 dark:border-rose-800 text-sm">
                    ...
                    <p class="italic text-rose-700 dark:text-rose-300">{{ $order->canceled_reason }}</p>
                </div>
            @endif
        </div>
                ...
                <div class="divide-y divide-zinc-100 dark:divide-zinc-800">
                    @foreach($order->items as $item)
                        <div class="py-4 flex justify-between items-center text-sm">
                            <div>
                                <p class="font-bold text-zinc-800 dark:text-zinc-200">T-Shirt ID Image: {{ $item->tshirt_image_id }}</p>
                            ...
                            <div class="pt-4 border-t border-zinc-100 dark:border-zinc-800 space-y-2">
                                ...
                                <form action="#" method="POST" class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="canceled_reason" placeholder="Ex: Rutura de stock da cor"
